  ...
  return (
    <Card className={`border-2 border-gray-300 relative rounded-3xl p-3 m-3 ${className}`}>
      <CardHeader className="p-0 pb-2">
        <h3 className="text-base font-normal absolute -top-3 left-2 bg-white px-2">Personal Information & Credentials</h3>
      ...
      <CardContent className="p-0">
        <div className="flex flex-col md:flex-row p-2 mb-2">
          ...
          <div className="w-full md:w-1/5 m-2 flex flex-col justify-center">
            <h4 className="text-lg font-semibold">Dr. John Doe, 32</h4>
            <p className="text-md">Cardiologist</p>
          </div>
          <div className="w-full md:w-3/5 flex flex-wrap md:flex-nowrap gap-7 justify-evenly">
            <div className="flex flex-col gap-2">
              <div className="flex flex-col">
                ...
                <span className="text-sm">09/11/24</span>
              </div>
              <div className="flex flex-col">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex flex-col">
                ...
                <span className="text-sm">john@pxr.care</span>
              </div>
              <div className="flex flex-col">
                <span className="text-xs font-light text-gray-600 text-gray-600">Contact Number</span>
                <span className="text-xs">+91 8921773573</span>
              </div>
            </div>
            <div className="flex flex-col gap-2">
              <div className="flex flex-col">
